...
---
⚡ This email was automatically generated by our AI agent system powered by AgentMail!
          ...
          html: `
            <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
              <div style="text-align: center; margin-bottom: 40px;">
                <h1 style="color: #37352F; font-size: 32px; margin: 0;">📸 Contrast</h1>
              ...
              <div style="background: #F7F6F3; border-radius: 8px; padding: 24px; margin: 30px 0;">
                <h3 style="color: #37352F; font-size: 18px; margin: 0 0 16px 0;">📋 Proposed Package</h3>
